...
const PATHS: Record<string, string> = {
  ...
  wand: 'M2 14 9.5 6.5M11 1.5l.7 1.8 1.8.7-1.8.7-.7 1.8-.7-1.8-1.8-.7 1.8-.7ZM4 2l.5 1.3L5.8 3.8 4.5 4.3 4 5.6 3.5 4.3 2.2 3.8 3.5 3.3ZM13.5 9l.4 1 1 .4-1 .4-.4 1-.4-1-1-.4 1-.4Z',
  orbit:
    'M8 8m-1.2 0a1.2 1.2 0 1 0 2.4 0a1.2 1.2 0 1 0-2.4 0M14.5 8c0 2.1-2.9 3.8-6.5 3.8S1.5 10.1 1.5 8 4.4 4.2 8 4.2s6.5 1.7 6.5 3.8Z',
  fly: 'M1.5 7.5 14.5 2l-3.8 12L8 9.2 1.5 7.5ZM8 9.2 14.5 2',
  frame:
    'M2 5.5V2h3.5M10.5 2H14v3.5M14 10.5V14h-3.5M5.5 14H2v-3.5M8 8m-1.6 0a1.6 1.6 0 1 0 3.2 0a1.6 1.6 0 1 0-3.2 0',
  grid: 'M2 2h12v12H2ZM2 6h12M2 10h12M6 2v12M10 2v12',
  circle: 'M8 8m-5.8 0a5.8 5.8 0 1 0 11.6 0a5.8 5.8 0 1 0-11.6 0',
